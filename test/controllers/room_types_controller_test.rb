...
class RoomTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create room_type" do
    assert_difference("RoomType.count") do
      post room_types_url, params: { room_type: { description: @room_type.description, kids_accepted: @room_type.kids_accepted, max_people: @room_type.max_people, type: @room_type.type } }
    end
  ...
  test "should update room_type" do
    patch room_type_url(@room_type), params: { room_type: { description: @room_type.description, kids_accepted: @room_type.kids_accepted, max_people: @room_type.max_people, type: @room_type.type } }
